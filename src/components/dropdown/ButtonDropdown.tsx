...
const ButtonDropdown = React.forwardRef<HTMLButtonElement, ButtonMenuProps>(({ text, icon, onClick, additionalClasses, textClasses, iconClasses }, ref) => {
    const buttonClasses = `flex w-full flex-row items-center justify-between font-medium text-gray-950 rounded-lg px-3 py-2 hover:bg-slate-100 ${additionalClasses || ''}`;
